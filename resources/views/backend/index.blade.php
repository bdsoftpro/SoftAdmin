...
@section('content')
    <div class="page-content">
        <div class="widgets">
            ...
            <div class="panel widget center bgimage" style="background-image:url({{ URL::to(config('softadmin.assets_path')) }}/images/widget-backgrounds/02.png);">
                ...
                <div class="panel-content">
                    ...
                    <?php $user_count = SBD\Softadmin\Models\User::count(); ?>
                    ...
                    <a href="{{ route('softadmin.users.index') }}" class="btn btn-primary">View All Users</a>
                </div>
            </div>
            <?php } ?>
            ...
            <div class="panel widget center bgimage" style="background-image:url({{ URL::to(config('softadmin.assets_path')) }}/images/widget-backgrounds/03.png);">
                ...
                <div class="panel-content">
                    ...
                    <?php $post_count = SBD\Softadmin\Models\Post::count(); ?>
                    <h4>{{ $post_count }} Post(s)</h4>
                    <p>You have {{ $post_count }} Posts in your database. Click on 'View All Posts' below to view all posts.</p>
                    <a href="{{ route('softadmin.posts.index') }}" class="btn btn-primary">View All Posts</a>
                </div>
            </div>
            <?php } ?>
            ...
            <div class="panel widget center bgimage" style="background-image:url({{ URL::to(config('softadmin.assets_path')) }}/images/widget-backgrounds/04.png);">
                ...
                <div class="panel-content">
                    ...
                    <?php $page_count = SBD\Softadmin\Models\Page::count(); ?>
                    <h4>{{ $page_count }} Page(s)</h4>
                    <p>You have {{ $page_count }} Pages in your database. Click on 'View All Pages' below to view all pages.</p>
                    <a href="{{ route('softadmin.pages.index') }}" class="btn btn-primary">View All Pages</a>
                </div>
            </div>
            <?php } ?>
        </div>
        ...
        <div style="padding:15px;">
            <?php $google_analytics_client_id = Softadmin::setting("google_analytics_client_id"); ?>
