        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="admin-section-title">
                    <h3><i class="softadmin-images"></i> Media</h3>
                </div>
                <div class="clear"></div>
                ...
                <div id="filemanager">
                    ...
                    <div id="toolbar">
                        <div class="btn-group offset-right">
                            <button type="button" class="btn btn-primary" id="upload"><i class="softadmin-upload"></i>
                                Upload
                            </button>
                            <button type="button" class="btn btn-primary" id="new_folder"
                                    onclick="jQuery('#new_folder_modal').modal('show');"><i class="softadmin-folder"></i>
                                Add folder
                            </button>
                        </div>
                        <button type="button" class="btn btn-default" id="refresh"><i class="softadmin-refresh"></i>
                        </button>
                        <div class="btn-group offset-right">
                            <button type="button" class="btn btn-default" id="move"><i class="softadmin-move"></i> Move
                            </button>
                            <button type="button" class="btn btn-default" id="rename"><i class="softadmin-character"></i>
                                Rename
                            </button>
                            <button type="button" class="btn btn-default" id="delete"><i class="softadmin-trash"></i>
                                Delete
                            </button>
                        </div>
                    </div>
                    ...
                    <div id="content">
                        ...
                        <div class="breadcrumb-container">
                            ...
                            <div class="toggle"><span>Close</span><i class="softadmin-double-right"></i></div>
                        </div>
                        <div class="flex">
                            ...
                            <div id="left">
                                ...
                                <div id="file_loader">
                                    <div id="file_loader_inner">
                                        <div class="icon softadmin-helm"></div>
                                    </div>
                                    <p>LOADING YOUR MEDIA FILES</p>
                                </div>

                                <div id="no_files">
                                    <h3><i class="softadmin-meh"></i> No files in this folder.</h3>
                                </div>
                                ...
                                <div class="right_details">
                                    <div class="detail_img @{{ selected_file.type }}">
                                        ...
                                        <template
                                            ...
                                            <i class="softadmin-file-text-o"></i>
                                        </template>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"><i class="softadmin-move"></i> Move File/Folder</h4>
                                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"
                                            aria-hidden="true">&times;</button>
                                    <h4 class="modal-title"><i class="softadmin-character"></i> Rename File/Folder</h4>
                                </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                <h4 class="modal-title"><i class="softadmin-folder"></i> Add New Folder</h4>
                            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                <h4 class="modal-title"><i class="softadmin-warning"></i> Are You Sure</h4>
                            </div>

                            <div class="modal-body">
                                <h4>Are you sure you want to delete '<span class="confirm_delete_name"></span>'</h4>
                                <h5 class="folder_warning"><i class="softadmin-warning"></i> Deleting a folder will remove
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                <h4 class="modal-title"><i class="softadmin-warning"></i> Drag and drop files or click
                                    below to upload</h4>
                            </div>
