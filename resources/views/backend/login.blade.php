...
<body class="login-page">
    ...
    <div id="login_section">
        <div class="content">
            ...
            <p>Sign in below:</p>
            <div style="clear:both"></div>
            <form action="{{ route('softadmin.login') }}" method="POST" id="login">
                {{ csrf_field() }}
    ...
    <script>
        login_btn = document.getElementById("softadmin-login-btn");
        login_btn.addEventListener("click", function () {
            var originalHeight = login_btn.offsetHeight;
            login_btn.style.height = originalHeight + 'px';
            document.querySelector('#softadmin-login-btn span.login_text').style.display = 'none';
            document.querySelector('#softadmin-login-btn span.login_loader').style.display = 'block';
        });
    </script>
