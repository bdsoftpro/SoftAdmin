...
<?php
$user_avatar = Softadmin::image(Auth::user()->avatar);
                ...
                <div class="navbar-header">
                    ...
                    <ol class="breadcrumb">
                        @if(count(Request::segments()) == 1)
                            <li class="active"><i class="softadmin-boat"></i> Dashboard</li>
                        @else
                            <li class="active">
                                <a href="{{ route('softadmin.dashboard')}}"><i class="softadmin-boat"></i> Dashboard</a>
                            </li>
                        @endif
                        <?php $breadcrumb_url = ''; ?>
                        @for($i = 1; $i <= count(Request::segments()); $i++)
                            <?php $breadcrumb_url .= '/' . Request::segment($i); ?>
                            @if(Request::segment($i) != ltrim(route('softadmin.dashboard', [], false), '/') && !is_numeric(Request::segment($i)))
                    ...
                    <button type="button" class="navbar-right-expand-toggle pull-right visible-xs">
                        <i class="softadmin-list icon"></i>
                    </button>
                </div>
                <ul class="nav navbar-nav navbar-right">
                    <button type="button" class="navbar-right-expand-toggle pull-right visible-xs">
                        <i class="softadmin-x icon"></i>
                    </button>
                    ...
                    <li class="dropdown profile">
                        ...
                        <ul class="dropdown-menu dropdown-menu-animated">
                            ...
                            <li class="divider"></li>
                            <li>
                                <a href="{{ route('softadmin.profile') }}"><i class="softadmin-person"></i> Profile</a>
                            </li>
                            <li>
                                <a href="{{ route('softadmin.logout') }}"><i class="softadmin-power"></i> Logout</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div class="side-menu sidebar-inverse">
            <nav class="navbar navbar-default" role="navigation">
                <div class="side-menu-container">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="{{ route('softadmin.dashboard') }}">
                            <div class="icon softadmin-helm"></div>
                            <div class="title">{{Softadmin::setting('admin_title')}}</div>
                        </a>
                    ...
                    <div class="panel widget center bgimage"
                        ...
                        <div class="panel-content">
                            ...
                            <a href="{{ route('softadmin.profile') }}" class="btn btn-primary">Profile</a>
