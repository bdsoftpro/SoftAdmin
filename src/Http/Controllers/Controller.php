        ...
        switch ($row->type) {
            ...
            case 'image':
                if ($request->hasFile($row->field)) {
                    ...
                    Storage::put(config('softadmin.storage.subfolder').$fullPath, (string) $image, 'public');
                    ...
                    if (isset($options->thumbnails)) {
                        foreach ($options->thumbnails as $thumbnails) {
                            ...
                            Storage::put(config('softadmin.storage.subfolder').$path.$filename.'-'.$thumbnails->name.'.'.$file->getClientOriginalExtension(),
                                (string) $image, 'public');
                        }
                    }
