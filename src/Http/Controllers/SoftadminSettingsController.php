...
class SoftadminSettingsController extends Controller
{
    public function index()
    {
        // Check permission
        Softadmin::can('browse_settings');
    ...
    public function delete_value($id)
    {
        ...
        if (isset($setting->id)) {
            ...
            if ($setting->type == 'image') {
                if (Storage::exists(config('softadmin.storage.subfolder').$setting->value)) {
                    Storage::delete(config('softadmin.storage.subfolder').$setting->value);
                }
            }
            $setting->value = '';
            $setting->save();
