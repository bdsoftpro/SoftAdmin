...
class ControllersCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'softadmin:controllers';
     ...
     * @var string
     */
    protected $description = 'Publish all the controllers from Softadmin.';
    ...
    public function fire()
    {
        ...
        $this->info('Published Softadmin controllers!');
    }
    ...
    protected function generateContent($stub, $class)
    {
        ...
        $content = str_replace(
            'FullBaseDummyClass',
            'SBD\\Softadmin\\Http\\Controllers\\'.$class,
            $content
        );
