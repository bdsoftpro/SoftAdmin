...
@section('content')
    <div class="page-content container-fluid">
        <form role="form" action="@if(isset($dataTypeContent->id)){{ route('softadmin.posts.update', $dataTypeContent->id) }}@else{{ route('softadmin.posts.store') }}@endif" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="softadmin-character"></i> Post Title
                                <span class="panel-desc"> The title for your post</span>
                            </h3>
                            <div class="panel-actions">
                                <a class="panel-action softadmin-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <div class="panel-actions">
                                <a class="panel-action softadmin-resize-full" data-toggle="panel-fullscreen" aria-hidden="true"></a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id">
                                    @foreach(SBD\Softadmin\Models\Category::all() as $category)
                    ...
                    <div class="panel panel-bordered panel-primary">
                        ...
                        <div class="panel-body">
                            @if(isset($dataTypeContent->image))
                                <img src="{{ Softadmin::image( $dataTypeContent->image ) }}" style="width:100%" />
                            @endif
        ...
        <form id="my_form" action="{{ route('softadmin.upload') }}" target="form_target" method="post" enctype="multipart/form-data" style="width:0px;height:0;overflow:hidden">
            {{ csrf_field() }}
