...
use SBD\Softadmin\Http\Controllers\Traits\DatabaseQueryBuilder;
...
class DatabaseTest extends TestCase
{
    ...
    public function test_can_create_table()
    {
        ...
        // Create table
        $this->post(route('softadmin.database.store'), [
            'name'     => 'voyagertest',
            'field'    => [
                'id',
                'tiny_int_field',
        ...
        $this->assertRedirectedToRoute('softadmin.database.index', [], [
    ...
    public function test_can_update_table_with_same_fields()
    {
        ...
        $this->put(route('softadmin.database.update', ['voyagertest']), [
            'name'           => 'voyagertest',
    ...
    public function test_can_delete_table()
    {
        ...
        $this->delete(route('softadmin.database.destroy', ['voyagertest']));
