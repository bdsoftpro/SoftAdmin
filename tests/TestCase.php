...
class TestCase extends OrchestraTestCase
{
    ...
    {
        return [
            SoftadminServiceProvider::class,
        ];
    }
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        // Setup Softadmin configuration
        $app['config']->set('softadmin.user.namespace', User::class);
    ...
    {
        $this->artisan('softadmin:install', ['--with-dummy' => $this->withDummy]);
    }
